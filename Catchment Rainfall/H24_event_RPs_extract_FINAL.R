...
rainfall_FEH_out <- "Data/H24 results/CatAvg_rainfall_RPs_from_FEH22_grid_extraction.csv"
...
Extracted_rainfall_from_csv_1h <- read.csv("Data/H24 Results/Station_FEH22_depths_1h.csv")[ , 6:29]
Extracted_rainfall_from_csv_6h <- read.csv("Data/H24 Results/Station_FEH22_depths_6h.csv")[ , 6:29]
Extracted_rainfall_from_csv_1d <- read.csv("Data/H24 Results/Station_FEH22_depths_1d.csv")[ , 6:29]
Extracted_rainfall_from_csv_4d <- read.csv("Data/H24 Results/Station_FEH22_depths_4d.csv")[ , 6:29]
...
for (i in 1:NEv) {
  ...
  Site_extracted_rainfall <- unlist(Extracted_rainfall_from_csv_1h[which(Metadata$NRFA_ID == Events$NRFA[i])[1], ])
  ...
  RP_AMAX_1h[i] <- I4PLA(Site_extracted_rainfall[M1h:X1h], RPList[M1h:X1h], Events$Depth.1h[i])
...
for (i in 1:NEv) {
  ...
  Site_extracted_rainfall <- unlist(Extracted_rainfall_from_csv_6h[which(Metadata$NRFA_ID == Events$NRFA[i])[1], ])
  ...
  RP_AMAX_6h[i] <- I4PLA(Site_extracted_rainfall[M6h:X6h], RPList[M6h:X6h], Events$Depth.6h[i])
...
for (i in 1:NEv) {
  ...
  Site_extracted_rainfall <- unlist(Extracted_rainfall_from_csv_1d[which(Metadata$NRFA_ID == Events$NRFA[i])[1], ])
  ...
  RP_AMAX_1d[i] <- I4PLA(Site_extracted_rainfall[M1d:X1d], RPList[M1d:X1d], Events$Depth.1d[i])
...
for (i in 1:NEv) {
  ...
  Site_extracted_rainfall <- unlist(Extracted_rainfall_from_csv_4d[which(Metadata$NRFA_ID == Events$NRFA[i])[1], ])
  ...
  RP_AMAX_4d[i] <- I4PLA(Site_extracted_rainfall[M4d:X4d], RPList[M4d:X4d], Events$Depth.4d[i])
